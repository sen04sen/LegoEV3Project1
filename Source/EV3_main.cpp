...
struct edge {
	int dt;	
    const function<void()> u;
};

double stadegd;
double Pr = 0.3;

double mm_gr = 0.005; // 1 миллиметр * mm_gr = 1 градус
double dws = 130; // расстояние между датчиками и колёсами
double proe = 50; // проезд, чтобы датчики с линии ушли
int d90 = 250;
int d180 = 500;
int black = 25;
int bluck = 35;
...
void f1(int dist) { // два датчика, бело-чёрная линия, левый датчик до чёрного и правый датчик до чёрного

}

void f2(int dist) { // два датчика, бело-черная линия, правый датчик до чёрного

}

void f3(int dist) { // два датчика, бело-черная линия, левый датчик до чёрного

}

void f4(int dist) { // два датчика, бело-черная линия, градусы

}

void f5(int dist) { // правый датчик справа от линии, бело-черная линия, левый датчик до чёрного
