...
Speed ZERO = Speed(20, 20, 0.35, 0.1, 0, 0, 0, 0); // p.s. для ИГОРЯ замедлил
//Speed ONEMOTOR = Speed(100, 20, 0, 0, 0, 100, 100, 0);    ///< Для moveB или moveС
Speed ONEMOTOR = Speed(20, 20, 0.35, 0.1, 0, 0, 0, 0); // p.s. для ИГОРЯ замедлил
//Speed MOVEBC = Speed(100, 20, 0, 0, 100, 250, 250, 70);      ///< Для moveBC
Speed MOVEBC = Speed(20, 20, 0.35, 0.1, 0, 0, 0, 0); // p.s. для ИГОРЯ замедлил
//Speed TURN = Speed(100, 15, 0, 0, 100, 300, 300, 50);        ///< Для turn
Speed TURN = Speed(20, 20, 0.35, 0.1, 0, 0, 0, 0); // p.s. для ИГОРЯ замедлил
