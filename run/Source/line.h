...
void line(Speed p, int32_t dist, int32_t type, bool uping = true, bool downing = true, double end_preview = standart_line_preview_looking) {
    ...
    vector<int32_t> errors = vector<int32_t>(lineArrayLen, 0);
